  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 flex items-center justify-center px-4">
        <Card className="p-8 max-w-md w-full text-center shadow-2xl border-2 border-primary/20">
          <div className="flex justify-center mb-6">
            <div className="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center">
              <CheckCircle className="w-14 h-14 text-primary" />
            </div>
          </div>
          <h2 className="text-2xl font-bold mb-3">تم استلام صور الهوية!</h2>
          <p className="text-muted-foreground mb-6 leading-relaxed">
            شكراً لك، سيتم مراجعة بياناتك من قِبل فريقنا وسيتم التواصل معك قريباً
          </p>
