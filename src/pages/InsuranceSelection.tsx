...
const comprehensiveTemplates: CompanyTemplate[] = [
  {
    ...
    features: [
      ...
      "قطع غيار أصلية 100%",
      "سيارة بديلة مجانية",
      "خدمة VIP على مدار الساعة",
      "تغطية الكوارث الطبيعية",
      "تأمين على السائق والركاب",
    ],
    rating: 4.9,
    isPopular: true,
  },
  {
    ...
    discount: 35,
    features: [
      "تغطية بلاتينية شاملة",
      "قطع غيار وكالة",
      "سيارة بديلة فورية",
      "تأمين على السائق",
      "خدمة مساعدة على الطريق",
...
const InsuranceSelection = () => {
  ...
  usePresence(applicationId || undefined, "insurance_selection");
  ...
  const handleSelectCompany = async (company: InsuranceCompany) => {
    ...
    navigate(
      `/payment?company=${encodeURIComponent(company.name)}&price=${company.salePrice}&regularPrice=${company.regularPrice}`,
    );
  };
        ...
        <section className="py-8 px-4 md:px-6">
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-3">اختر التأمين المناسب لك</h1>
            ...
            <div className="text-center mb-6">
              <p className="text-muted-foreground text-sm">
                ...
                {insuranceType === "comprehensive" ? "شامل" : "ضد الغير"}
              </p>
            </div>

            {/* Insurance Cards Grid */}
            <div
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 mb-12"
              key={sortBy}
            >
                ...
                >
                  ...
                  {company.isPopular && (
                    <div className="absolute top-2 left-2 z-10">
                      <Badge
                        variant="outline"
                        className="bg-background/90 border-primary text-primary text-xs px-1.5 py-0.5"
                      >
                  ...
                  <div className="p-4">
                      ...
                      <img
                        ...
                        onError={(e) => {
                          (e.target as HTMLImageElement).src =
                            "https://via.placeholder.com/120x60?text=" + encodeURIComponent(company.shortName);
                        }}
                      />
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg p-3 mb-3">
                      ...
                      <div className="text-center">
                        <span className="text-xl font-bold text-primary">{company.salePrice.toLocaleString()}</span>
                        <span className="text-xs text-primary mr-1">ر.س</span>
                      </div>
                      <p className="text-[10px] text-muted-foreground text-center mt-0.5">شامل الضريبة</p>
                    </div>
            ...
            <div className="flex justify-center">
              <Button variant="outline" size="lg" onClick={() => navigate("/vehicle-info")} className="px-8 rounded-xl">
                العودة للخلف
              </Button>
            </div>
          </div>
